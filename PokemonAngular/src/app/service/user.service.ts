...
export class UserService {
  ...
  _leaderUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/leader";
  //URL endpoint for registering a new user.
  _createUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/create";
  //URL endpoint for generating a new pokemon.
  _generateUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/generate";
  //URL endpoint for getting active users collection.

  _userCollectionUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/collection";
  //URL endpoint for user login.
  _loginUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/login";
  //URL endpoint for shop getALl
  _shopUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/shop";
  //URL endpoint for buy pokemon
  _buyUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/redeem";
  _getDuplicatesUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/collection";
  _redeemUrl = "ec2-18-220-58-191.us-east-2.compute.amazonaws.com:8080/PokemonCollector/redeem";
